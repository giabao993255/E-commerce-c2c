...
if($_SERVER["REQUEST_METHOD"] == "POST")
		 ...
		 
 {
	 ...
	 if($count == 1)
	 {
		 $profile_update_error = "<div class ='message-error alert alert-danger'>This Username Is Already Existed, Please Select Another One</div>";
		 
		 redirect_profile_edit($profile_update_error, 5);
	 }
	 else
	 {
			...
			$profile_update_success = "<span class='message-success alert alert-success'>Record Updated Successfully</span>";
			
			redirect_home($profile_update_success);
	...
	
		 {
			 ...
			 $profile_update_error = "<span class='message-error alert alert-danger'>You Are Not Permited To Access This Page Directly</span>";
			 
			 redirect_login($profile_update_error);
