...
if(isset($_SESSION['Username']))
	
   {
	   ...
	   echo "<h1 class='edit text-center'>Edit Member</h1>";
  ...
  if ($count > 0) { ?>
	...
	<div class="container">
		<form class="form-horizontal" action="member_update.php" method="post" enctype="multipart/form-data">
...
<?php
	   ...
	   
	   		{
				...
				$member_edit_error = '<div class="alert alert-danger">Theres No Such ID</div>';

				redirect_home($member_edit_error);
	...
	
	{
			 ...
			 $member_edit_error = "<span class='message-error alert alert-danger'>You Are Not Permited To Access This Page Directly</span>";
